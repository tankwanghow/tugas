defmodule Argus.Accounts do
  ...
  alias Argus.Accounts.{User, UserToken, UserNotifier}
  ...
  See `Argus.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `Argus.Accounts.User.password_changeset/3` for a list of supported options.
