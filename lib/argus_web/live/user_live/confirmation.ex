defmodule ArgusWeb.UserLive.Confirmation do
    ...
    <Layouts.mobile_standalone flash={@flash}>
      <div class="w-full max-w-sm card bg-base-100 shadow">
        <div class="card-body gap-4">
          ...
          <p :if={!@user.confirmed_at} class="text-xs text-base-content/60 text-center">
            Tip: enable passwords later in account settings.
          </p>
        </div>
      </div>
