defmodule TugasWeb do
  ...
  def controller do
    quote do
      ...
      use Gettext, backend: TugasWeb.Gettext
  ...
  defp html_helpers do
    quote do
      ...
      import TugasWeb.TodoBadge
      import TugasWeb.TodoTeamActivity
      import TugasWeb.TodoActionsMenu
